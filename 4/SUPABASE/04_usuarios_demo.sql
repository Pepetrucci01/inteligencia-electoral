...
DECLARE
    ...
    v_super   UUID := '00000000-0000-0000-0000-000000000001'; -- admin@sistema.mx
    v_admin   UUID := '00000000-0000-0000-0000-000000000002'; -- candidato@demo.mx
    v_cord_a  UUID := '00000000-0000-0000-0000-000000000003'; -- coord.a@demo.mx
    v_cord_b  UUID := '00000000-0000-0000-0000-000000000004'; -- coord.b@demo.mx
    v_ldr138  UUID := '00000000-0000-0000-0000-000000000010'; -- lider138@demo.mx
    v_cap017  UUID := '00000000-0000-0000-0000-000000000017'; -- cap017@demo.mx
    v_cap018  UUID := '00000000-0000-0000-0000-000000000018'; -- cap018@demo.mx
BEGIN
